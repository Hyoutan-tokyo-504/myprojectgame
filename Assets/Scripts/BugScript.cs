...
public class BugScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lm5 = GameObject.Find("EnemyManager").GetComponent<EnemyManager>();
    ...
    void Attack()
    {
        if (animator.GetCurrentAnimatorStateInfo(0).IsName("attack1") == true)
        {
            ...
            if (shotInterval % 30 == 0)
            {
                ...
                //audiosource.Play();
                GameObject bullet = (GameObject)Instantiate(BugAttack, this.transform.position - new Vector3(0, -1, 3), this.transform.rotation);
        ...
        if (attackcount == 5)
        {
            ...
            {
                yield return new WaitForSeconds(1.0f);
                GameObject explodebullet = (GameObject)Instantiate(BugExplode, this.transform.position - new Vector3(0, -1, 3), this.transform.rotation);
